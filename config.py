...
ALIASES = {
    ...
    "SIDO": ["Sido Muncul", "PT Industri Jamu dan Farmasi Sido Muncul"],
    ...
    "JSMR": ["Jasa Marga", "PT Jasa Marga"],
    "WIKA": ["Wijaya Karya", "PT Wijaya Karya"],
    "PTPP": ["Pembangunan Perumahan", "PT Pembangunan Perumahan", "PT PP"],
    "ADHI": ["Adhi Karya", "PT Adhi Karya"],
    "WSKT": ["Waskita Karya", "PT Waskita Karya"],
